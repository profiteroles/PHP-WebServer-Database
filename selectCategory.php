<form action="listByCategory.php" method="post">
    <?php
    //connect to the database
    require('connect.php');

    // get query result of suppliers
    $res = mysqli_query($conn, "SELECT id, name FROM category");
    ...
    if (mysqli_num_rows($res) > 0) {
        ...
        echo "<option value = '0'> Select Category Name</option>";
        ...
        echo '<button type="submit" name="submit" id="submit" class="btn btn-default">Get Category</button>';
